...
export const DORA_LONG_SENTENCE = {
  "CONFIRM_MIGRATION_DISCLAIMER_1": "I understand it may take 7 days until my tokens are available on the Dora Vota.",
  ...
  "MIGRATION_FAQ_HOW_LONG_ANSWER": "The migration will be finished within 7 days. Note that the migration time is subject to change. As more addresses complete token migration, expected token migration time will prolong.",
